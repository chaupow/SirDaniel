 ...
 */
public class SirDanielArbitrator implements Runnable
{
   ...
   */
  public SirDanielArbitrator(Behavior[] behaviorList, boolean returnWhenInactive)
  {
   ...
   * @param behaviorList An array of Behavior objects.
   */
  public SirDanielArbitrator(Behavior[] behaviorList)
  {
